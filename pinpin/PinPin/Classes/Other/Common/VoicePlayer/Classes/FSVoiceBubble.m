...
//        [_contentButton setImage:[UIImageNamed(@"fs_icon_wave_2") imageWithOverlayColor:waveColor]  forState:UIControlStateNormal];
        [_contentButton setImage:[UIImageNamed(@"voice3") imageWithOverlayColor:waveColor]  forState:UIControlStateNormal];
...
//        UIImage *image2 = [UIImageNamed(@"fs_icon_wave_2") imageWithOverlayColor:_animatingWaveColor];
        UIImage *image0 = [UIImageNamed(@"voice1") imageWithOverlayColor:_animatingWaveColor];
        UIImage *image1 = [UIImageNamed(@"voice2") imageWithOverlayColor:_animatingWaveColor];
        UIImage *image2 = [UIImageNamed(@"voice3") imageWithOverlayColor:_animatingWaveColor];
             UIImage *image3 = [UIImageNamed(@"voice4") imageWithOverlayColor:_animatingWaveColor];
        _contentButton.imageView.animationImages = @[image0, image1, image2,image3];
